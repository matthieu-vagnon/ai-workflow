...
export async function runKeys({ VERSION }) {
  console.clear();
  const banner = [
    "                                      __  _               ",
    " _ ____ ____ _ __ _ _ _  ___ _ _     / / | |_____ _  _ ___",
    "| '  \\ V / _` / _` | ' \\/ _ \\ ' \\   / /  | / / -_) || (_-<",
    "|_|_|_\\_/\\__,_\\__, |_||_\\___/_||_| /_/   |_\\_\\___|\\_,/__/",
    "              |___/                               |__/    ",
  ];
  ...
  while (true) {
    ...
    const options = [{ value: "add", label: "Add a key" }];
